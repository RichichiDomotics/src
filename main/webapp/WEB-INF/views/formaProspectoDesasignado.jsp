...
<h1 id="item_name">Prospectos Desasignados</h1>
...
<div class="bloquedata">
    <div class="form-group">
		...
		<input type='text' placeholder="Prospecto" id="razonSocial" name='razonSocial' value='' class="form-control razonSocial" required>
  	</div>
</div> 	
<div class="bloquedata">
  	<div class="form-group">	
...
$(document).ready(function(){
	...
	buscaProspectof = function(razonSocial,estatus){
		$.ajax("consultaProspectosDesasignado", {
			"type": "POST",
			"beforeSend": function() {
			...
			"data": { nombre:razonSocial , estatus:""},
			"async": true
		});
	}

	if ($(".razonSocial").val() == "") {
		buscaProspectot($(".razonSocial").val());
		$("#inicial").val("");
	}

	function buscaProspectot(razonSocial) {
		//razonSocial = $(".razonSocial").val();
		$.ajax("consultaProspectosDesasignado", {
			"type": "POST",
			"beforeSend": function () {
