<form:form id="frmDiafec" name="frmDiafec" method="post" role="form" action="reporteSalidaPorFechasres">
  	...
  	<div class="bloquedata">
  		<div class="form-group">
				...
				<div class="row-fluid input-append">
					...
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;	
					<button class="btn btn-primary btn-small busca" type="button" frmname="frmDiafec" urlenvio = "reporteSalidaPorFechasres">
