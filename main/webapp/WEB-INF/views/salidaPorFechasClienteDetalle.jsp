<form:form name="frmDiaFDC" id="frmDiaFDC" method="post" role="form" action="reporteSalidaPorFechasClDetres">
  		...
  		<div class="form-group">
            ...
            <div class="row-fluid input-append">
                ...
                <span class="add-on">
			 	...
			 	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;	
                <button class="btn btn-primary btn-small busca" type="button" frmname="frmDiaFDC"  urlenvio = "reporteSalidaPorFechasClDetres">
