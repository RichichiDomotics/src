...
function displayKeyCode(tecla){
...

    {
        ...
        textbox.value="";  //Cuando le haces esto le impides la escritura del caracter en la caja
					...
					<div id="forma-ingreso" class="tab-pane in active">
						<div class="bloqueforma">
							<div class="form-group">
								...
								<input type='text' placeholder="RAZ&Oacute;N SOCIAL" id="razonSocial" name='razonSocial' size="75" maxlength="60" class="form-control razonSocial" required onkeypress="javascript:this.value=this.value.toUpperCase(); return soloLetras(event)" >
							</div>
							<div class="form-group">
