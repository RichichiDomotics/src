<form:form name="frmDiaFDC" id="frmDiaFDC" method="post" role="form" action="reporteEntradaPorFechasClDetres">
  <section class="grupodedatosreporte">
  	<div class="bloquedata">
  		<div class="form-group">
  			<div class="row-fluid">
				<label for="fechaInicioXFechasCliente">Total Detalle por Fechas y Cliente</label>
			</div>
        </div>
  		<div class="form-group">
            ...
            <div class="row-fluid input-append">
                ...
                <button class="btn btn-primary btn-small busca" type="button" frmname="frmDiaFDC"  urlenvio = "reporteEntradaPorFechasClDetres">
