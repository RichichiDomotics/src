...
<div class="component">
    ...
    <tr class="odd">
      ...
      <td align="center">
          <div align="center">
              <div class="btn-group">
                <button class="btn btn-mini btn-primary convierteClienteAutorizabtn" consultaProspectoId="${c.razonSocial}" idProspecto="${c.idProspecto}"><i class="icon-check"></i>Autorizar</button>
                <button class="btn btn-mini btn-danger rechazarProspecto" consultaProspectoId2="${c.razonSocial}" idProspecto2="${c.idProspecto}"><i class="icon-external-link"></i>Rechazar</button>
              </div>
          </div>
