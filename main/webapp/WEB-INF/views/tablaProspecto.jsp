...
<table aria-describedby="sample-table-2_info" class="table table-striped table-bordered table-hover dataTable" id="tablaResultadoProspectoJefe">
    ...
    <tr>
      <!--td align="center" ><button class="btn btn-minier btn-primary convierteClienteAgregabtn" consultaProspectoId="${c.razonSocial}" idProspecto="${c.idProspecto}">Autorizar</button></td-->
