...
<div class="alert alert-block alert-info">
	<i class="icon-cogs blue"></i>
		Bienvenido al
		<strong class="blue">
			<c:if test="${rolef ne 'ROLE_JEFEEJE' && rolef ne 'ROLE_EJECUTIVO'}">
				GIA
			</c:if>
	...
	<div class="row-fluid">
		<div class="span7 infobox-container">
					...
					<div class="infobox-content">
						<ul>
						  ...
						  <c:if test="${rolef eq 'ROLE_JEFEEJE' || (rolef eq 'ROLE_ADMIN') }">
							  ...
							  <li>
								  <a href="<c:url value="/prospectosAll" />">
									  <i class="icon-globe fa fa-caret-right"></i>
			...
			<c:if test="${(rolef eq 'ROLE_ALMACENISTA') || (rolef eq 'ROLE_ADMIN') ||(rolef eq 'ROLE_EJECUTIVO') ||(rolef eq 'ROLE_JEFEEJE') || ('ROLE_COMERCIAL')}">
			<div class="infobox infobox-blue">
				<div class="infobox-icon">
					<i class="icon-book"></i>
				</div>
					...
					<div class="infobox-content">
						<ul>
							...
							<c:if test="${rolef eq 'ROLE_JEFEEJE' || rolef eq 'ROLE_EJECUTIVO'}">
								...
								<li><a href="<c:url value="reportesprospectosJefe" />">
									<i class="icon-book fa fa-caret-right"></i>
								...
								<c:if test="${rolef eq 'ROLE_EJECUTIVO'}">
								<li><a href="<c:url value="reportesprospectos" />">
									<i class="icon-book fa fa-caret-right"></i>
									Reporte de Prospectos
								</a>
								</li>
								...
								<c:if test="${rolef eq 'ROLE_JEFEEJE' || rolef eq 'ROLE_EJECUTIVO'}">
								<li><a href="<c:url value="reporteDetalleProspectos" />">
									<i class="icon-book fa fa-caret-right"></i>
