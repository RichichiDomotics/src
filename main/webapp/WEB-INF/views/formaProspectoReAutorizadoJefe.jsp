...
<h1 id="item_name">Autorizar Prospectos</h1>
...
<div class="bloquedata">
    <div class="form-group">
		...
		<input type='text' placeholder="Prospecto" id="razonSocial" name='razonSocial' value='' class="form-control" required>
  	</div>
</div> 	
<div class="bloquedata">
  	<div class="form-group">	
...
$(document).ready(function(){
	...
	buscaProspectof = function(razonSocial,estatus){
		$.ajax("consultaProspectosFiltroJefe", {
			"type": "POST",
			"beforeSend": function() {
	...
	function buscaProspectot() {
		$.ajax("consultaProspectoReAutorizadoJefe", {
			"type": "POST",
			"beforeSend": function () {
				$("#buscaProspectodiv").css("font-size", "27px");
				$("#buscaProspectodiv").html('<img src="resources/img/loader.GIF"/>');
